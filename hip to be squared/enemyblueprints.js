const enemyBlueprints = [
    { // 0 knife
        ...
        size: 125, health: 175, boss: true, rotateToTarget: true, speed: 0.05, target: "playerAdvanced", ephemeral: true, drawPath: JSON.parse(
        ...
        size: 200, health: 300, projectile: true, rotateToTarget: true, immovable: true, speed: 0, target: "random", drawPath: JSON.parse(
