const enemyBlueprints = [
    { // 0 knife
        ...
        size: 45, health: 6, rotateToTarget: true, speed: -0.05, target: "playerAdvanced", drawPath: JSON.parse(
            ...
            if (warn) {
                ...
                enemy.attackListboom.push([enemy.x,enemy.y,direction]);
                enemy.speed = 0; enemy.vx = 0; enemy.vy = 0;
                attackWarnings.push(["stab",warn*4,warn*4,enemy.x + Math.cos(direction)*300,enemy.y + Math.sin(direction)*300,250,direction]);
            } else {
                enemiesBuffer.push(new Enemy(enemyBlueprints[5], {size: 40, speed: 6, x: enemy.attackListboom[0][0] + Math.cos(enemy.attackListboom[0][2])*50, y: enemy.attackListboom[0][1] + Math.sin(enemy.attackListboom[0][2])*50, dirToTarget: enemy.attackListboom[0][2]}));
                enemy.speed = -0.05;
                enemy.attackListboom.splice(0,1);
            }
        }
        ...
        size: 55, health: 9, rotateToTarget: true, speed: -0.05, target: "playerAdvanced", drawPath: JSON.parse(
           ...
           `[{"type":"point","x":25,"y":-250,"move":false},{"type":"point","x":-150,"y":0,"move":false},{"type":"point","x":25,"y":250,"move":false},{"type":"stroke","r":125,"g":125,"b":125},{"type":"point","x":25,"y":-250,"move":false},{"type":"point","x":50,"y":-150,"move":false},{"type":"point","x":100,"y":-75,"move":false},{"type":"point","x":125,"y":0,"move":false},{"type":"point","x":100,"y":75,"move":false},{"type":"point","x":50,"y":150,"move":false},{"type":"point","x":25,"y":250,"move":false},{"type":"point","x":75,"y":150,"move":false},{"type":"point","x":125,"y":100,"move":false},{"type":"point","x":150,"y":25,"move":false},{"type":"point","x":150,"y":-25,"move":false},{"type":"point","x":125,"y":-100,"move":false},{"type":"point","x":75,"y":-150,"move":false},{"type":"close"},{"type":"fill","r":125,"g":100,"b":50},{"type":"stroke","r":50,"g":50,"b":50},{"type":"point","x":-150,"y":0,"move":false},{"type":"point","x":125,"y":-25,"move":false},{"type":"point","x":175,"y":0,"move":false},{"type":"point","x":125,"y":25,"move":false},{"type":"close"},{"type":"fill","r":200,"g":75,"b":75},{"type":"stroke","r":80,"g":40,"b":40},{"type":"point","x":100,"y":-75,"move":false},{"type":"point","x":175,"y":0,"move":false},{"type":"point","x":100,"y":75,"move":false},{"type":"point","x":125,"y":0,"move":false},{"type":"close"},{"type":"fill","r":200,"g":75,"b":75},{"type":"stroke","r":80,"g":40,"b":40}]`
            ...
            if (warn) {
                ...
                enemiesBuffer.push(new Enemy(enemyBlueprints[7], {x: enemy.attackListbeat[0][0] + 20*Math.cos(enemy.dirToTarget), y: enemy.attackListbeat[0][1] + 20*Math.sin(enemy.dirToTarget), dirToTarget: enemy.dirToTarget}));
                enemy.speed = -0.05;
        ...
        size: 125, health: 500, boss: true, rotateToTarget: true, speed: 0.05, target: "playerAdvanced", ephemeral: true, drawPath: JSON.parse(
            ...
            if (warn) {
                ...
                enemiesBuffer.push(new Enemy(enemyBlueprints[9],{ x: enemy.attackListdrum[0][0], y: enemy.attackListdrum[0][1]}));
            ...
            if (warn) {
                ...
                enemiesBuffer.push(new Enemy(enemyBlueprints[9],{ x: enemy.attackListmelee[0][0], y: enemy.attackListmelee[0][1], size: 850 }));
                enemy.speed = 0.05;
            ...
            if (warn) {
                ...
                enemiesBuffer.push(new Enemy(enemyBlueprints[10], {x: enemy.attackListslice[0][0] + Math.cos(enemy.attackListslice[0][2])*50, y: enemy.attackListslice[0][1] + Math.sin(enemy.attackListslice[0][2])*50, dirToTarget: enemy.attackListslice[0][2]}));
                enemy.speed = 0.05;
    ...
    },{ // 11 Zweihänder sword projectile
        ...
        size: 65, health: 9, rotateToTarget: true, speed: 0.1, target: "playerAdvanced", drawPath: JSON.parse(
            ...
            if (warn) {
                ...
                enemy.dirToTarget = enemy.attackListbeat[0][2];
                enemiesBuffer.push(new Enemy(enemyBlueprints[14], {x: enemy.attackListbeat[0][0] + 20*Math.cos(enemy.dirToTarget), y: enemy.attackListbeat[0][1] + 20*Math.sin(enemy.dirToTarget), dirToTarget: enemy.dirToTarget}));
                enemy.speed = 0.1;
                enemy.target = "playerAdvanced";
                enemy.attackListbeat.splice(0,1);
            }
            ...
            if (warn) {
                enemy.target = "direction";
                enemy.attackListboom.push([enemy.x,enemy.y,enemy.dirToTarget]);
                enemy.vx = 0; enemy.vy = 0;
                enemy.speed = 0;
                ...
                enemy.dirToTarget = enemy.attackListboom[0][2];
                enemiesBuffer.push(new Enemy(enemyBlueprints[14], {size:150,speed:0.6,x: enemy.attackListboom[0][0] + 20*Math.cos(enemy.dirToTarget), y: enemy.attackListboom[0][1] + 20*Math.sin(enemy.dirToTarget), dirToTarget: enemy.dirToTarget}));
                enemy.speed = 0.1;
                enemy.target = "playerAdvanced";
                enemy.attackListboom.splice(0,1);
            }
        ...
        size: 66, health: 0.07, projectile: true, rotateToTarget: true, immovable: true, speed: 0.35, target: "direction", drawPath: JSON.parse(
