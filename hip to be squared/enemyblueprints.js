const enemyBlueprints = [
    { // 0 spear
        ...
        size: 75, health: 11000, boss: ["Virus", "#922", 2], spawnPosition: [0,0],rotateToTarget: false, target:"playerAdvanced", randomRotation: true, speed: 0.02, immovable: false, offscreen: false, drawPath: JSON.parse(
