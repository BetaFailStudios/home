const enemyBlueprints = [
    { // 0 spear
        ...
        size: 20, health: 1, projectile: true, rotateToTarget: true, immovable: true, speed: 3, target: "direction", drawPath: JSON.parse(
        ...
        size: 20, health: 1, projectile: true, rotateToTarget: true, immovable: true, speed: 0, target: "direction", noWarnWait: true, drawPath: JSON.parse(
            `[{"type":"point","x":-250,"y":-250},{"type":"point","x":250,"y":-25},{"type":"point","x":-250,"y":250},{"type":"close"},{"type":"fill","r":150,"g":150,"b":150},{"type":"stroke","r":75,"g":75,"b":75}]`
        )
    },{ // 19 microchip
        ...
        size: 75, health: 2500, boss: ["Central Processing Unit", "#292", 1], spawnPosition: [0,-300],rotateToTarget: false, speed: 0, immovable: true, drawPath: JSON.parse(
        ...
        size: 85, health: 200, num: 1, rotateToTarget: false, randomRotation: true, speed: 0.03, drawPath: JSON.parse(
        ...
        size: 15, projectile: true, target: "direction", rotateToTarget: true, speed: 2, drawPath: JSON.parse(
        ...
        size: 50, health: 100, num: 2, rotateToTarget: true, randomRotation: false, speed: -0.05, drawPath: JSON.parse(
        ...
        size: 15, projectile: true, immovable: true, target: "direction", rotateToTarget: true, speed: 2, drawPath: JSON.parse(
        ...
        size: 35, health: 70, num: 3, rotateToTarget: false, randomRotation: true, speed: 0.05, drawPath: JSON.parse(
        ...
        size: 15, projectile: true, immovable: true, target: "direction", rotateToTarget: true, speed: 3, drawPath: JSON.parse(
        ...
        size: 35, health: 100, num: 2, rotateToTarget: false, randomRotation: true, speed: 0.05, drawPath: JSON.parse(
        ...
        size: 30, health: 40, num: 6, target: "playeradvanced", rotateToTarget: false, randomRotation: true, speed: 0, drawPath: JSON.parse(
        ...
        size: 80, health: 200, target: "playeradvanced", rotateToTarget: false, randomRotation: true, speed: 0, drawPath: JSON.parse(
            `[{"type":"point","x":-50,"y":-250},{"type":"point","x":-150,"y":-225},{"type":"point","x":-225,"y":-150},{"type":"point","x":-250,"y":-50},{"type":"point","x":-250,"y":50},{"type":"point","x":-225,"y":150},{"type":"point","x":-150,"y":225},{"type":"point","x":-50,"y":250},{"type":"point","x":50,"y":250},{"type":"point","x":150,"y":225},{"type":"point","x":225,"y":150},{"type":"point","x":250,"y":50},{"type":"point","x":250,"y":-50},{"type":"point","x":225,"y":-150},{"type":"point","x":150,"y":-225},{"type":"point","x":50,"y":-250},{"type":"close"},{"type":"fill","r":150,"g":150,"b":160},{"type":"stroke","r":80,"g":80,"b":80},{"type":"point","x":0,"y":-225},{"type":"point","x":-25,"y":-212.5},{"type":"point","x":-25,"y":-25},{"type":"point","x":-212.5,"y":-25},{"type":"point","x":-225,"y":0},{"type":"point","x":-212.5,"y":25},{"type":"point","x":-25,"y":25},{"type":"point","x":-25,"y":212.5},{"type":"point","x":0,"y":225},{"type":"point","x":25,"y":212.5},{"type":"point","x":25,"y":25},{"type":"point","x":212.5,"y":25},{"type":"point","x":225,"y":0},{"type":"point","x":212.5,"y":-25},{"type":"point","x":25,"y":-25},{"type":"point","x":25,"y":-212.5},{"type":"close"},{"type":"fill","r":150,"g":200,"b":210},{"type":"stroke","r":75,"g":125,"b":125}]`
        ), a2(enemy, warn) {
            if (warn) return;
            enemy.speed = 4;
        ...
        size: 100, health: 1500, boss: ["Immune System", "#922", 1], spawnPosition: [-800,-400], coSpawn: [[39,-275,-425],[39,275,-425],[39,800,-400],[39, -800,400],[39,-275,425],[39,275,425],[39,800,400]],rotateToTarget: true, speed: 0, immovable: true, offscreen: true, drawPath: JSON.parse(
        ...
        size: 75, health: 9000, boss: ["Virus", "#922", 2], spawnPosition: [0,0],rotateToTarget: false, target:"playerAdvanced", randomRotation: true, speed: 0.02, immovable: false, offscreen: false, drawPath: JSON.parse(
