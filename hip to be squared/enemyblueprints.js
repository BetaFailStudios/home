const enemyBlueprints = [
    { // 0 spear
        ...
        size: 35, health: 40, target: "playerAdvanced", rotateToTarget: true, speed: -0.05, drawPath: JSON.parse(
        ...
        size: 50, health: 45, rotateToTarget: true, speed: 0.1, drawPath: JSON.parse(
        ...
        size: 85, health: 55, rotateToTarget: false, speed: 0.2, drawPath: JSON.parse(
        ...
        size: 85, health: 50, rotateToTarget: true, speed: 0.2, drawPath: JSON.parse(
        ...
        size: 80, health: 50, rotateToTarget: true, speed: 0.2, target: "playeradvanced", drawPath: JSON.parse(
