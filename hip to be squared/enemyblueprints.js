...
const enemyBlueprints = [
    ...
    {  // 19 microchip
        ...
        size: 40, health: 25, rotateToTarget: false, speed: 0.1, drawPath: pathParse(
        ...
        size: 35, health: 15, num: 2, rotateToTarget: true, speed: 0.1, drawPath: pathParse(
            `[{"type":"point","x":0,"y":-75},{"type":"point","x":-250,"y":0},{"type":"point","x":0,"y":75},{"type":"point","x":250,"y":0},{"type":"close"},{"type":"fill","r":255,"g":255,"b":0},{"type":"stroke","r":50,"g":50,"b":0}]`
        ), a2(enemy, warn) {
            if (warn) {
                enemy.dirToTarget = (Math.atan((player.y-enemy.y)/(player.x-enemy.x)) + Math.PI*(player.x < enemy.x)) || (Math.PI*(player.x < enemy.x));
    ...
    {  // 30 white cell
        size: 85, health: 60, num: 1, rotateToTarget: false, randomRotation: true, speed: 0.03, drawPath: pathParse(
        ...
        size: 50, health: 32, num: 2, rotateToTarget: true, randomRotation: false, speed: -0.05, drawPath: pathParse(
        ...
        size: 35, health: 22, num: 3, rotateToTarget: false, randomRotation: true, speed: 0.05, drawPath: pathParse(
        ...
        size: 35, health: 35, num: 2, rotateToTarget: false, randomRotation: true, speed: 0.05, drawPath: pathParse(
        ...
        size: 30, health: 15, num: 6, target: "playeradvanced", rotateToTarget: false, randomRotation: true, speed: 0, drawPath: pathParse(
        ...
        size: 80, health: 60, target: "playeradvanced", rotateToTarget: false, randomRotation: true, speed: 0, drawPath: pathParse(
            `[{"type":"point","x":-50,"y":-250},{"type":"point","x":-150,"y":-225},{"type":"point","x":-225,"y":-150},{"type":"point","x":-250,"y":-50},{"type":"point","x":-250,"y":50},{"type":"point","x":-225,"y":150},{"type":"point","x":-150,"y":225},{"type":"point","x":-50,"y":250},{"type":"point","x":50,"y":250},{"type":"point","x":150,"y":225},{"type":"point","x":225,"y":150},{"type":"point","x":250,"y":50},{"type":"point","x":250,"y":-50},{"type":"point","x":225,"y":-150},{"type":"point","x":150,"y":-225},{"type":"point","x":50,"y":-250},{"type":"close"},{"type":"fill","r":150,"g":150,"b":160},{"type":"stroke","r":80,"g":80,"b":80},{"type":"point","x":0,"y":-225},{"type":"point","x":-25,"y":-212.5},{"type":"point","x":-25,"y":-25},{"type":"point","x":-212.5,"y":-25},{"type":"point","x":-225,"y":0},{"type":"point","x":-212.5,"y":25},{"type":"point","x":-25,"y":25},{"type":"point","x":-25,"y":212.5},{"type":"point","x":0,"y":225},{"type":"point","x":25,"y":212.5},{"type":"point","x":25,"y":25},{"type":"point","x":212.5,"y":25},{"type":"point","x":225,"y":0},{"type":"point","x":212.5,"y":-25},{"type":"point","x":25,"y":-25},{"type":"point","x":25,"y":-212.5},{"type":"close"},{"type":"fill","r":150,"g":200,"b":210},{"type":"stroke","r":75,"g":125,"b":125}]`
        ), a2(enemy, warn) {
            if (warn) return;
            enemy.speed = 4;
        ...
        size: 75, health: 2500, boss: ["Virus", "#922", 2], spawnPosition: [0,0],rotateToTarget: false, target:"playerAdvanced", randomRotation: true, speed: 0.02, immovable: false, offscreen: false, drawPath: pathParse(
    ...
    ,{ // 44 big square
        size: 80, health: 100, target: "playeradvanced", rotateToTarget: false, speed: 0, drawPath: pathParse(
        ...
        size: 30, health: 100, target: "playeradvanced", rotateToTarget: true, speed: 0, drawPath: pathParse(
        ...
        size: 25, health: 25, num: 5, target: "playeradvanced", rotateToTarget: true, speed: 0, drawPath: pathParse(
        ...
        size: 65, health: 100, target: "playeradvanced", rotateToTarget: true, speed: 0.1, drawPath: pathParse(
        ...
        size: 35, health: 100, target: "playeradvanced", rotateToTarget: false, randomRotation: true, speed: 0.1, drawPath: pathParse(
            `[{"type":"point","x":-200,"y":250,"move":false},{"type":"point","x":-200,"y":-250,"move":false},{"type":"point","x":250,"y":0,"move":false},{"type":"close"},{"type":"point","x":-100,"y":-100,"move":true},{"type":"point","x":-100,"y":100,"move":false},{"type":"point","x":75,"y":0,"move":false},{"type":"close"},{"type":"fill","r":50,"g":175,"b":50},{"type":"stroke","r":50,"g":125,"b":50}]`
        ), a2(enemy, warn) {
        ...
        size: 85, health: 100, num: 1, rotateToTarget: false, speed: 0.03, drawPath: pathParse(
        ...
        size: 40, health: 90, rotateToTarget: true, speed: 0, target: "player", drawPath: pathParse(
