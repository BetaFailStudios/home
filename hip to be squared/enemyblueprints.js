...
const enemyBlueprints = [
    { // 0 spear
        size: 60, health: 10, rotateToTarget: true, speed: 0.15, drawPath: pathParse(
            ...
            if (!warn) enemiesBuffer.push(new Enemy(enemyBlueprints[5], {noProjPierce: true, x: enemy.x + Math.cos(enemy.dirToTarget)*25, y: enemy.y + Math.sin(enemy.dirToTarget)*25, dirToTarget: enemy.dirToTarget, size: 15, speed: 0.3}));
        }, 
        ...
        size: 125, health: 0.1, projectile: true, rotateToTarget: true, immovable: true, speed: 4, target: "direction", drawPath: pathParse(
        ...
        size: 55, health: 8, rotateToTarget: true, speed: -0.05, target: "player", drawPath: pathParse(
            ...
            if (!warn) {
                enemiesBuffer.push(new Enemy(enemyBlueprints[2], {noProjPierce: true, x: enemy.x + Math.cos(enemy.dirToTarget)*25, y: enemy.y + Math.sin(enemy.dirToTarget)*25, dirToTarget: enemy.dirToTarget, size: 30, speed: 0.2}));
                enemy.vx *= 0.5;
                enemy.vy *= 0.5;
            }
        }, a3(enemy, warn) { enemyAttackTeleport(enemy,warn,enemy.attackLista3,55) }
    },{ // 4 rapier
        size: 45, health: 8, rotateToTarget: true, speed: -0.05, target: "playerAdvanced", drawPath: pathParse(
        ...
        size: 20, health: 0.1, projectile: true, rotateToTarget: true, immovable: true, speed: 6, target: "direction", drawPath: pathParse(
        ...
        size: 55, health: 9, rotateToTarget: true, speed: -0.05, target: "playerAdvanced", drawPath: pathParse(
        ...
        ), drawIdlePath: pathParse(
            `[{"type":"point","x":-50,"y":-250},{"type":"point","x":-50,"y":250,"move":false},{"type":"stroke","r":175,"g":175,"b":175},{"type":"point","x":-50,"y":-250,"move":false},{"type":"point","x":-25,"y":-150,"move":false},{"type":"point","x":25,"y":-75,"move":false},{"type":"point","x":50,"y":0,"move":false},{"type":"point","x":25,"y":75,"move":false},{"type":"point","x":-25,"y":150,"move":false},{"type":"point","x":-50,"y":250,"move":false},{"type":"point","x":0,"y":150,"move":false},{"type":"point","x":50,"y":100,"move":false},{"type":"point","x":75,"y":25,"move":false},{"type":"point","x":75,"y":-25,"move":false},{"type":"point","x":50,"y":-100,"move":false},{"type":"point","x":0,"y":-150,"move":false},{"type":"close"},{"type":"fill","r":125,"g":100,"b":50},{"type":"stroke","r":50,"g":50,"b":50}]`
        ), drawReadyPath: pathParse(
        ...
        size: 30, health: 0.07, projectile: true, rotateToTarget: true, immovable: true, speed: 6, target: "direction", drawPath: pathParse(
        ...
        a1(enemy, warn) { // wall explosion
            if (warn) {
                ...
                enemiesBuffer.push(new Enemy(enemyBlueprints[9],{ size: 250, x: enemy.attackLista1[0][0], y: enemy.attackLista1[0][1]}));
        ...
        a7(enemy, warn) { // large explosion
            if (warn) {
                ...
                enemiesBuffer.push(new Enemy(enemyBlueprints[9],{ x: enemy.attackLista7[0][0], y: enemy.attackLista7[0][1], size: 500 }));
                enemy.speed = 0.05;
        ...
        size: 150, ephemeral: true, health: 0, projectile: true, randomRotation: true, immovable: true, speed: 0, target: "direction", drawPath: pathParse(
        ...
        size: 200, health: 5, projectile: true, rotateToTarget: true, immovable: true, speed: 3, target: "direction", drawPath: pathParse(
        ...
        size: 75, health: 1, projectile: true, ephemeral: true, rotateToTarget: true, immovable: true, speed:-0.1, target: "direction", drawPath: pathParse(
        ...
        size: 45, health: 1, projectile: true, ephemeral: true, rotateToTarget: true, immovable: true, speed: -0.1, target: "direction", drawPath: pathParse(
        ...
        size: 55, health: 10, rotateToTarget: true, speed: 0.1, target: "playerAdvanced", drawPath: pathParse(
        ...
        size: 65, health: 0.07, projectile: true, rotateToTarget: true, immovable: true, speed: 0.35, target: "direction", drawPath: pathParse(
        ...
        a2(enemy, warn) { // fan spray towards player
            if (warn) {
                ...
                //createLineWarning(enemy.x,enemy.y,enemy.x+Math.cos(enemy.dirToTarget-Math.PI/3),enemy.y+Math.sin(enemy.dirToTarget-Math.PI/3));
        ...
        size: 70, health: 1, projectile: true, rotateToTarget: true, immovable: true, speed: 0, target: "direction", noWarnWait: true, drawPath: pathParse(
        ...
        size: 20, health: 1, projectile: true, rotateToTarget: true, immovable: true, speed: 3, target: "direction", drawPath: pathParse(
        ...
        size: 20, health: 1, projectile: true, rotateToTarget: true, immovable: true, speed: 0, target: "direction", noWarnWait: true, drawPath: pathParse(
            `[{"type":"point","x":-250,"y":-250},{"type":"point","x":250,"y":-25},{"type":"point","x":-250,"y":250},{"type":"close"},{"type":"fill","r":150,"g":150,"b":150},{"type":"stroke","r":75,"g":75,"b":75}]`
        )
    },{ // 19 microchip
        size: 35, health: 18, target: "playerAdvanced", rotateToTarget: true, speed: -0.05, drawPath: pathParse(
        ...
        size: 40, health: 15, rotateToTarget: false, speed: 0.1, drawPath: pathParse(
        ...
        a3(enemy, warn) { // large explosion
            if (warn) {
                ...
                if (enemy.drawPath == enemy.onePath) enemy.drawPath = enemy.zeroPath;
                else enemy.drawPath = enemy.onePath;
                enemiesBuffer.push(new Enemy(enemyBlueprints[9],{ x: enemy.attackLista3[0][0], y: enemy.attackLista3[0][1], size: 350 }));
                enemy.speed = 0.05;
                enemy.attackLista3.splice(0,1);
            }
        }
    },{ // 22 capacitor
        size: 50, health: 25, rotateToTarget: true, speed: 0.1, drawPath: pathParse(
            ...
            if (warn) {
                ...
                attackWarnings.push(["circle",game.warnDelay,game.warnDelay,...pos,150]);
                enemy.vx = 0; enemy.vy = 0; enemy.speed = 0;
            } else {
                enemiesBuffer.push(new Enemy(enemyBlueprints[9],{ x: enemy.attackLista2[0][0], y: enemy.attackLista2[0][1], size: 150 }));
                enemy.speed = 0.05;
                enemy.attackLista2.splice(0,1);
            }
        },
        ...
        size: 85, health: 25, rotateToTarget: false, speed: 0.2, drawPath: pathParse(
        ...
        size: 85, health: 20, rotateToTarget: true, speed: 0.2, drawPath: pathParse(
        ...
        size: 80, health: 20, rotateToTarget: true, speed: 0.2, target: "playeradvanced", drawPath: pathParse(
        ...
        size: 75, health: 1000, boss: ["Central Processing Unit", "#292", 1], spawnPosition: [0,-300],rotateToTarget: false, speed: 0, immovable: true, drawPath: pathParse(
            ...
            if (warn) {
                const things = [];
                for (var i = 0; i < 3; i++) {
                    const direction = -Math.PI/3 + Math.PI*Math.random()*5/3;
                ...
                enemy.attackLista1[0].forEach( (direction) => {
                    enemiesBuffer.push(new Enemy(enemyBlueprints[27], {size: 20, x: enemy.x + Math.cos(direction)*25, y: enemy.y + Math.sin(direction)*25, dirToTarget: direction, speed: 0.3}));
                })
                enemy.attackLista1.splice(0,1);
            }
        }, a3(enemy, warn) {
            ...
            if (warn) {
                ...
                enemy.attackLista5[0].forEach(item => {
                    enemiesBuffer.push(new Enemy(enemyBlueprints[9],{ size: 150, x: item[0], y: item[1]}));
                });
                enemy.attackLista5.splice(0,1);
            }
            ...
            if (warn) {
                ...
                for (var i = 0; i < 5; i++) things.splice(Math.floor(Math.random()*things.length),1);
                ...
                enemy.attackLista7[0].forEach(item => {
                    enemiesBuffer.push(new Enemy(enemyBlueprints[9],{ size: 200, x: item[0], y: item[1]}));
                });
                enemy.attackLista7.splice(0,1);
            }
        },
        ...
        size: 35, health: 3, num: 3, rotateToTarget: true, speed: 0.1, drawPath: pathParse(
        ...
        size: 35, health: 10, num: 2, rotateToTarget: true, speed: 0.1, drawPath: pathParse(
            `[{"type":"point","x":0,"y":-75},{"type":"point","x":-250,"y":0},{"type":"point","x":0,"y":75},{"type":"point","x":250,"y":0},{"type":"close"},{"type":"fill","r":255,"g":255,"b":0},{"type":"stroke","r":50,"g":50,"b":0}]`
        ), a2(enemy, warn) {
            if (warn) {
                enemy.dirToTarget = (Math.atan((player.y-enemy.y)/(player.x-enemy.x)) + Math.PI*(player.x < enemy.x)) || (Math.PI*(player.x < enemy.x));
        ...
        size: 85, health: 50, num: 1, rotateToTarget: false, randomRotation: true, speed: 0.03, drawPath: pathParse(
        ...
        size: 50, health: 30, num: 2, rotateToTarget: true, randomRotation: false, speed: -0.05, drawPath: pathParse(
        ...
        a2(enemy, warn) {
            if (warn) {
                const things = [];
                for (var i = 0; i < 2; i++) {
                    const direction = enemy.dirToTarget-Math.PI/16-Math.PI/8*Math.random()+Math.PI/8*3*i;
                    x = Math.cos(direction)*100;
                    y = Math.sin(direction)*100;
                    attackWarnings.push(["line",game.warnDelay,game.warnDelay,enemy.x+x,enemy.y+y,x,y]);
                    things.push(direction);
                ...
                enemy.vx = 0; enemy.vy = 0;
                enemy.attackLista2.push(things);
            } else {
                enemy.attackLista2[0].forEach( (direction) => {
                    enemiesBuffer.push(new Enemy(enemyBlueprints[33], {noProjPierce: true, size: 15, x: enemy.x, y: enemy.y, dirToTarget: direction, speed: 0.3}));
                })
                enemy.attackLista2.splice(0,1);
                enemy.vx = 0; enemy.vy = 0;
            }
        },
        a3(enemy, warn) { enemyAttackSlice(enemy,warn,enemy.attackLista3,true,"stab",30,enemy.dirToTarget,enemyBlueprints[33],-0.05,1)}, 
    },{ // 33 green droplet
        ...
        size: 35, health: 20, num: 3, rotateToTarget: false, randomRotation: true, speed: 0.05, drawPath: pathParse(
        ...
        a2(enemy, warn) {
            if (warn) {
                const things = [];
                for (var i = 0; i < 2; i++) {
                    const direction = enemy.dirToTarget-Math.PI/5 + Math.PI*Math.random()*2/5;
                    x = Math.cos(direction)*100;
                    y = Math.sin(direction)*100;
                    attackWarnings.push(["line",game.warnDelay,game.warnDelay,enemy.x+x,enemy.y+y,x,y]);
                    things.push(direction);
                ...
                enemy.attackLista2[0].forEach( (direction) => {
                    enemiesBuffer.push(new Enemy(enemyBlueprints[35], {noProjPierce: true, size: 15, x: enemy.x, y: enemy.y, dirToTarget: direction, speed: 0.3}));
                })
                enemy.attackLista2.splice(0,1);
                enemy.vx = 0; enemy.vy = 0;
            }
        },
        a3(enemy, warn) { enemyAttackSlice(enemy,warn,enemy.attackLista3,true,"stab",35,enemy.dirToTarget,enemyBlueprints[35],0.05) }
    },{ // 35 blue droplet
        size: 15, projectile: true, immovable: true, target: "direction", rotateToTarget: true, speed: 3, drawPath: pathParse(
        ...
        size: 35, health: 30, num: 2, rotateToTarget: false, randomRotation: true, speed: 0.05, drawPath: pathParse(
        ...
        size: 30, health: 10, num: 6, target: "playeradvanced", rotateToTarget: false, randomRotation: true, speed: 0, drawPath: pathParse(
        ...
        a3(enemy, warn) { // grow
            if (warn) {
                ...
                enemy.speed = 0;
                ease(enemy,"size",125,0.1);
                enemy.reset = [ () => { setTimeout( () => {enemy.offscreen = false; enemy.immovable = false;},400); enemy.speed = 0; ease(enemy,"size",30,0.4) }, 20 ];
            }
        }, 
    },{ // 38 big cross
        size: 80, health: 50, target: "playeradvanced", rotateToTarget: false, randomRotation: true, speed: 0, drawPath: pathParse(
            `[{"type":"point","x":-50,"y":-250},{"type":"point","x":-150,"y":-225},{"type":"point","x":-225,"y":-150},{"type":"point","x":-250,"y":-50},{"type":"point","x":-250,"y":50},{"type":"point","x":-225,"y":150},{"type":"point","x":-150,"y":225},{"type":"point","x":-50,"y":250},{"type":"point","x":50,"y":250},{"type":"point","x":150,"y":225},{"type":"point","x":225,"y":150},{"type":"point","x":250,"y":50},{"type":"point","x":250,"y":-50},{"type":"point","x":225,"y":-150},{"type":"point","x":150,"y":-225},{"type":"point","x":50,"y":-250},{"type":"close"},{"type":"fill","r":150,"g":150,"b":160},{"type":"stroke","r":80,"g":80,"b":80},{"type":"point","x":0,"y":-225},{"type":"point","x":-25,"y":-212.5},{"type":"point","x":-25,"y":-25},{"type":"point","x":-212.5,"y":-25},{"type":"point","x":-225,"y":0},{"type":"point","x":-212.5,"y":25},{"type":"point","x":-25,"y":25},{"type":"point","x":-25,"y":212.5},{"type":"point","x":0,"y":225},{"type":"point","x":25,"y":212.5},{"type":"point","x":25,"y":25},{"type":"point","x":212.5,"y":25},{"type":"point","x":225,"y":0},{"type":"point","x":212.5,"y":-25},{"type":"point","x":25,"y":-25},{"type":"point","x":25,"y":-212.5},{"type":"close"},{"type":"fill","r":150,"g":200,"b":210},{"type":"stroke","r":75,"g":125,"b":125}]`
        ), a2(enemy, warn) {
            if (warn) return;
            enemy.speed = 4;
        ...
        a3(enemy, warn) { enemyAttackSlice(enemy,warn,enemy.attackLista3,true,"slice",70,enemy.dirToTarget,enemyBlueprints[35],0.1) }
    },{ // 39 --- Immune System
        size: 100, health: 1500, boss: ["Immune System", "#922", 1], spawnPosition: [-800,-400], coSpawn: [[39,-275,-425],[39,275,-425],[39,800,-400],[39, -800,400],[39,-275,425],[39,275,425],[39,800,400]],rotateToTarget: true, speed: 0, immovable: true, offscreen: true, drawPath: pathParse(
            `[{"type":"point","x":50,"y":-250},{"type":"point","x":150,"y":-225},{"type":"point","x":225,"y":-150},{"type":"point","x":250,"y":-50},{"type":"point","x":250,"y":50},{"type":"point","x":225,"y":150},{"type":"point","x":150,"y":225},{"type":"point","x":50,"y":250},{"type":"point","x":-50,"y":250},{"type":"point","x":-150,"y":225},{"type":"point","x":-225,"y":150},{"type":"point","x":-250,"y":50},{"type":"point","x":-250,"y":-50},{"type":"point","x":-225,"y":-150},{"type":"point","x":-150,"y":-225},{"type":"point","x":-50,"y":-250},{"type":"close"},{"type":"fill","r":175,"g":175,"b":175},{"type":"stroke","r":50,"g":50,"b":50},{"type":"point","x":225,"y":-150},{"type":"point","x":150,"y":-125},{"type":"point","x":100,"y":-75},{"type":"point","x":87.5,"y":-25},{"type":"point","x":87.5,"y":25},{"type":"point","x":100,"y":75},{"type":"point","x":150,"y":125},{"type":"point","x":225,"y":150},{"type":"point","x":250,"y":50},{"type":"point","x":250,"y":-50},{"type":"close"},{"type":"fill","r":200,"g":100,"b":100},{"type":"stroke","r":50,"g":50,"b":50},{"type":"point","x":237.5,"y":-100},{"type":"point","x":187.5,"y":-75},{"type":"point","x":162.5,"y":-25},{"type":"point","x":162.5,"y":25},{"type":"point","x":187.5,"y":75},{"type":"point","x":237.5,"y":100},{"type":"point","x":250,"y":50},{"type":"point","x":250,"y":-50},{"type":"close"},{"type":"fill","r":20,"g":20,"b":20},{"type":"stroke","r":50,"g":50,"b":50}]`
        ), flashPath: pathParse(
            `[{"type":"point","x":25,"y":-100},{"type":"point","x":100,"y":-250},{"type":"point","x":100,"y":-100},{"type":"point","x":250,"y":-150},{"type":"point","x":125,"y":0},{"type":"point","x":250,"y":125},{"type":"point","x":100,"y":100},{"type":"point","x":100,"y":250},{"type":"point","x":25,"y":100},{"type":"point","x":50,"y":0},{"type":"close"},{"type":"fill","r":200,"g":0,"b":0},{"type":"stroke","r":255,"g":175,"b":175}]`
        ), a1(enemy, warn) {
            if (!warn) enemiesBuffer.push(new Enemy(enemyBlueprints[40], {offscreen: true, immovable: true, x: enemy.x, y: enemy.y, dirToTarget: enemy.dirToTarget-Math.PI/4+Math.PI/2*Math.random(), size: 10, speed: 0.1}));
        },
        a2(enemy, warn) {
            if (warn) {
                const direction = -Math.PI/3 + Math.PI*Math.random()*5/3;
                x = Math.cos(direction)*100;
                y = Math.sin(direction)*100;
                attackWarnings.push(["slice",game.warnDelay,game.warnDelay,enemy.x+x,enemy.y+y,x,y,"slice",enemy.dirToTarget,60]);
                enemy.attackLista2.push(direction);
            } else {
                enemiesBuffer.push(new Enemy(enemyBlueprints[40], {size: 60, x: enemy.x + Math.cos(enemy.attackLista2[0])*25, y: enemy.y + Math.sin(enemy.attackLista2[0])*25, dirToTarget: enemy.attackLista2[0], speed: 0.3}));
                enemy.attackLista2.splice(0,1);
            }
        },
        a3(enemy, warn) {
            if (warn) {
                const direction = enemy.dirToTarget-Math.PI/6 + Math.PI*Math.random()/3;
                x = Math.cos(direction)*100;
                y = Math.sin(direction)*100;
                createLineWarning(enemy.x,enemy.y,enemy.x+x,enemy.y+y,"slice",direction,75);
                enemy.attackLista3.push([direction,x,y]);
                enemy.dirToTarget = direction;
                enemy.target = "direction";
            } else {
                let x = enemy.x+enemy.attackLista3[0][1]*2;
                let y = enemy.y+enemy.attackLista3[0][2]*2;
                effects.push(new Effect(enemy.x+enemy.attackLista3[0][1],enemy.y+enemy.attackLista3[0][2],enemyBlueprints[39].flashPath,150,20,enemy.attackLista3[0][0],0,1));
                for (var i = 0; true; i++) {
                    const enemy2 = new Enemy(enemyBlueprints[41], {size: 85, x: x, y: y, dirToTarget: enemy.attackLista3[0][0], speed: 0});
                    enemiesBuffer.push(enemy2);
                    x += enemy.attackLista3[0][1];
                    y += enemy.attackLista3[0][2];
                    ease(enemy2,"health",0,i/20);
                    if (Math.abs(x) > 950 || Math.abs(y) > 950) break;
                }
                enemy.target = "player";
                enemy.attackLista3.splice(0,1);
            }
        ...
        a4(enemy, warn) { // grow
            if (warn) {
                ...
                ease(enemy,"size",350,0.1);
                enemy.reset = [ () => { ease(enemy,"size",100,0.4) }, 20 ];
            }
        },
    },{ // 40 red droplet
        size: 15, projectile: true, target: "direction", rotateToTarget: true, speed: 2, drawPath: pathParse(
            `[{"type":"point","x":0,"y":-250},{"type":"point","x":-187.5,"y":-187.5},{"type":"point","x":-300,"y":0},{"type":"point","x":-187.5,"y":187.5},{"type":"point","x":0,"y":250},{"type":"point","x":187.5,"y":187.5},{"type":"point","x":250,"y":0},{"type":"point","x":187.5,"y":-187.5},{"type":"close"},{"type":"fill","r":100,"g":0,"b":0},{"type":"stroke","r":250,"g":20,"b":20}]`
        )
    },{ // 41 beam
        size: 15, projectile: true, target: "direction", rotateToTarget: true, speed: 2, drawPath: pathParse(
        ...
        size: 75, health: 2000, boss: ["Virus", "#922", 2], spawnPosition: [0,0],rotateToTarget: false, target:"playerAdvanced", randomRotation: true, speed: 0.02, immovable: false, offscreen: false, drawPath: pathParse(
            ...
            if (warn) {
                ...
                for (var i = 0; i < 3; i++) {                
                    ...
                    things.push(direction);
                    const x = Math.cos(direction)*100;
                    const y = Math.sin(direction)*100;
                    attackWarnings.push(["line",game.warnDelay,game.warnDelay,enemy.x+x,enemy.y+y,x,y]);
                }
                enemy.attackLista1.push(things);
            }
            else {  
                enemy.attackLista1[0].forEach(direction => enemiesBuffer.push(new Enemy(enemyBlueprints[40], {offset: enemy.size, offscreen: true, immovable: true, x: enemy.x, y: enemy.y, dirToTarget: direction, size: 10, speed: 0.15})));
                enemy.attackLista1.splice(0,1);
            }
        }, a2(enemy, warn) {
            if (warn) {
                const pos = [player.x-200+Math.random()*400,player.y-200+Math.random()*400];
                enemy.attackLista2.push(pos);
                attackWarnings.push(["circle",game.warnDelay,game.warnDelay,...pos,80]);
            } else {
                console.log(1)
                enemiesBuffer.push(new Enemy(enemyBlueprints[43], {size: 75,health: 0, offscreen: true, immovable: true, x: enemy.attackLista2[0][0], y: enemy.attackLista2[0][1]}));
                enemy.attackLista2.splice(0,1);
            }
        }, a3(enemy, warn) {
            if (warn) {
            ...
            if (warn) {
                const direction = enemy.dirToTarget+Math.PI/2*Math.random()-Math.PI/4;
                enemy.attackLista4.push(direction);
                const x = Math.cos(direction)*100;
                const y = Math.sin(direction)*100;
                enemy.speed = 0;
                enemy.vx = 0;
                enemy.vy = 0;
                createLineWarning(enemy.x,enemy.y,enemy.x+x,enemy.y+y,"stab",direction,25);
            }
            else {
                enemy.speed = 0.02;
                for (var speed = 0.15; speed < 0.75; speed += 0.05) enemiesBuffer.push(new Enemy(enemyBlueprints[40], {offset: enemy.size, startFast: true, offscreen: true, immovable: true, x: enemy.x, y: enemy.y, dirToTarget: enemy.attackLista4[0], size: 20, speed: speed}));
                enemy.attackLista4.splice(0,1);
            }
        },
        a5(enemy, warn) { // left
            if (!enemy.original) return;
            const things = [];
            if (warn) {
                x = -900;
                for (var y = -500+175*Math.random(); y < 500; y += 325) {
                    ...
                    enemiesBuffer.push(thing);
                    things.push(thing);
                    attackWarnings.push(["rect",game.warnDelay,game.warnDelay,x,y,-750,y,0,35]);
                }
                enemy.attackLista5.push(things);
            } else {
                enemy.attackLista5[0].forEach((item) => {
        ...
        a6(enemy, warn) { // right
            ...
            if (warn) {
                ...
                for (var y = -500+175*Math.random(); y < 500; y += 325) {
                    ...
                    enemiesBuffer.push(thing);
                    things.push(thing);
                    attackWarnings.push(["rect",game.warnDelay,game.warnDelay,x,y,750,y,Math.PI,35]);
                }
                enemy.attackLista6.push(things);
            } else {
                enemy.attackLista6[0].forEach((item) => {
        ...
        a7(enemy, warn) { // top
            ...
            if (warn) {
                ...
                for (var x = -900+175*Math.random(); x < 900; x += 325) {
                    ...
                    enemiesBuffer.push(thing);
                    things.push(thing);
                    attackWarnings.push(["rect",game.warnDelay,game.warnDelay,x,y,x,-350,Math.PI/2,35]);
                }
                enemy.attackLista7.push(things);
            } else {
                enemy.attackLista7[0].forEach((item) => {
        ...
        a8(enemy, warn) { // bottom
            ...
            if (warn) {
                ...
                enemy.attackLista8.push(things);
            } else {
                enemy.attackLista8[0].forEach((item) => {
                    item.speed = 1.25
                    item.vy = -10;
                });
        ...
        size: 80, health: 80, target: "playeradvanced", rotateToTarget: false, speed: 0, drawPath: pathParse(
        ...
        size: 30, health: 75, target: "playeradvanced", rotateToTarget: true, speed: 0, drawPath: pathParse(
        ...
        size: 25, health: 15, num: 5, target: "playeradvanced", rotateToTarget: true, speed: 0, drawPath: pathParse(
        ...
        size: 65, health: 80, target: "playeradvanced", rotateToTarget: true, speed: 0.1, drawPath: pathParse(
        ...
        size: 35, health: 70, target: "playeradvanced", rotateToTarget: false, randomRotation: true, speed: 0.1, drawPath: pathParse(
            `[{"type":"point","x":-200,"y":250,"move":false},{"type":"point","x":-200,"y":-250,"move":false},{"type":"point","x":250,"y":0,"move":false},{"type":"close"},{"type":"point","x":-100,"y":-100,"move":true},{"type":"point","x":-100,"y":100,"move":false},{"type":"point","x":75,"y":0,"move":false},{"type":"close"},{"type":"fill","r":50,"g":175,"b":50},{"type":"stroke","r":50,"g":125,"b":50}]`
        ), a2(enemy, warn) {
        ...
        size: 85, health: 80, num: 1, rotateToTarget: false, speed: 0.03, drawPath: pathParse(
        ...
        size: 40, health: 70, rotateToTarget: true, speed: 0, target: "player", drawPath: pathParse(
        ...
        size: 25, health: 5000, boss: ["??????????!!!!!     ", "#000", 1], spawnPosition: [0,0],rotateToTarget: false, passiveRotation: true, target:"playerAdvanced", speed: 0.15, immovable: false, offscreen: false, drawPath: player.inverseDrawPath, 
        phase: 0,
        tick(enemy) {
            switch(enemy.phase) {
                case 0: {
...
function enemyAttackSlice(enemy,warn,attackList,advanced,type,size,direction,reference,speed,projSpeed) {
    if (warn) {
        ...
        enemiesBuffer.push(new Enemy(reference, {health: (projSpeed === undefined || projSpeed), dirToTarget: enemy.dirToTarget, speed: projSpeed || 2, size:size, x: attackList[0][0] + 20*Math.cos(enemy.dirToTarget), y: attackList[0][1] + 20*Math.sin(enemy.dirToTarget)}));
        enemy.speed = speed;
