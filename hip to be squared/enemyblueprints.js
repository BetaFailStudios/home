const enemyBlueprints = [
    { // 0 spear
        ...
        size: 75, health: 3000, boss: ["Central Processing Unit", "#292", 1], spawnPosition: [0,-300],rotateToTarget: false, speed: 0, immovable: true, drawPath: JSON.parse(
            ...
            if (warn) {
                const things = [];
                for (var i = 0; i < 3; i++) {
                    const direction = -Math.PI/4 + 1.5*Math.PI*Math.random();
