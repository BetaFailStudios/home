const enemyBlueprints = [
    { // 0 spear
        ...
        size: 75, health: 2500, boss: ["Central Processing Unit", "#292", 1], spawnPosition: [0,-300],rotateToTarget: false, speed: 0, immovable: true, drawPath: pathParse(
        ...
        size: 75, health: 8000, boss: ["Virus", "#922", 2], spawnPosition: [0,0],rotateToTarget: false, target:"playerAdvanced", randomRotation: true, speed: 0.02, immovable: false, offscreen: false, drawPath: pathParse(
