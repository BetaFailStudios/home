function tickloop() {
    ...
    if (game.noEnemies && !game.notLocked) {
        ...
        if (game.regionNum != -1) ease(stats,"extraHealth",stats.extraHealthMax,(stats.extraHealthMax-stats.extraHealth)/stats.extraHealthMax*2);
    ...
    ctx.fillText("Version: b.1.7.3",700,470);
}
