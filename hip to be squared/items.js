...
/*SO*/},{
        ...
        bulletDrawPath: JSON.parse(
            ...
            stats.firerate *= 1.25 - 0.1*rarity;
...
/*RG*/},{
        ...
        bulletDrawPath: JSON.parse(
            ...
            stats.firerate *= 1.6;
            stats.damage *= 2.3 + 0.15*rarity;
            stats.bulletSpeed *= 2.5 + 0.2*rarity;
            stats.pierce = 1;
...
/*GC*/},{
        ...
        bulletDrawPath: JSON.parse(
            ...
            stats.firerate *= 0.11 - 0.013*rarity;
            stats.damage *= 0.15 + 0.02*rarity;
...
/*PC*/},{
        ...
        bulletDrawPath: JSON.parse(
            ...
            stats.firerate *= 0.9 - 0.1*rarity;
            stats.damage *= 0.6 + 0.05*rarity;
...
/*AI*/},{
        ...
        drawPath: JSON.parse(
            ...
            stats.firerate *= 0.65-0.15*rarity;
...
/*SW*/},{
        ...
        drawPath: JSON.parse(
            ...
            stats.extraIframes = (stats.extraIframes || 0) + 120 + 60*rarity;
        }
/*SH*/},{
        name: "Shadow",
...
/*CB*/},{
        ...
        drawPath: JSON.parse(
            ...
            if (enemy.health/enemy.healthMax > 0.75) return 1.75 + 0.4*rarity;
            else return 1;
        }
/*GU*/},{
        name: "Guillotine",
        ...
        drawPath: JSON.parse(
            ...
            if (enemy.health/enemy.healthMax < 0.5) return 1.5 + 0.3*rarity;
            else return 1;
        }
/*BH*/},{
        name: "Bull's Horn",
        ...
        drawPath: JSON.parse(
            ...
            if (stats.health <= stats.healthMax/2) return 2 + 0.5*rarity;
            else return 1;
        }
/*SG*/},{
        name: "Stun Gun",
...
/*HP*/},{
        ...
        drawPath: JSON.parse(
            ...
            if (Math.hypot(player.x-bullet.x,player.y-bullet.y) < 300) return 1.55 + 0.30*rarity;
            else return 1;
        }
/*RD*/},{
        name: "Red Dot",
...
/*MF*/},{
        ...
        drawPath: JSON.parse(
            ...
            bullets.push(new Bullet({x: bullet.x, y: bullet.y, speed: 20+rarity*5, direction: bullet.direction, size: 50+stats.bulletSize*(1+0.5*rarity), damage: bullet.damage * (0.3 + 0.15*rarity), lifetime: 0.2, drawPath: this.flashPath, wallPierce: true, pierce: 10,drawAlpha:0.4}));
        }
/*GH*/},{
        name: "Giant's Helmet",
...
/*OD*/},{
        ...
        drawPath: JSON.parse(
            ...
            return 1 + bullet.distance * (0.00060 + 0.00030 * rarity);
        }
/*CT*/},{
...
/*BP*/},{
        ...
        drawPath: JSON.parse(
            ...
            return 1 + stats.extraHealth*(0.25 + 0.15 * rarity);
        }
/*WC*/},{
        name: "Wind-up Crank",
...
/*TM*/},{
        ...
        drawPath: JSON.parse(
            ...
            if (!(game.tick%10)) bulletBuffer.push(new Bullet({x:player.x,y:player.y,speed:0,size:175+rarity*25,damage:1.5+1*rarity,drawPath:this.cloudPath,drawAlpha:0.1,lifetime:0.5,wallPierce:true}))
        }
/*SB*/},{
        name: "Smoke Bomb",
...
/*BH*/},{
        ...
        drawPath: JSON.parse(
            ...
            return 1 + bullet.tick * (0.005 + 0.003 * rarity);
        }
/*AM*/},{
        name: "Anger Mark",
...
/*MC*/},{
        ...
        drawPath: JSON.parse(
            ...
            if (random() < 0.2 + 0.1*rarity) {
                bullet.damage *= 1.6 + 0.3*rarity;
                bullet.size *= 2 + rarity;
            }
        }
    }
]
        ...
        if (reference) this.reference = reference;
            ...
            switch(type) {
                case "weapon": {
                    ...
                    if (this.reference.name == "Basic Gun" && !this.rarity) this.rarity++;
                    break;
                }
                case "relic": {
