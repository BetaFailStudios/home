...
const relics = [
    {
        ...
        drawPath: JSON.parse(
            ...
            if (player.health >= player.healthMax-2) return 1.2 + 0.08*rarity;
            else return 1;
        }
    },{
        name: "Spectacles",
        ...
        drawPath: JSON.parse(
            ...
            if (bullet.firstBullet) return 10 + 5*rarity;
            else return 1;
        }
    },{
        name: "Barbed Wire",
        desc: "Double damage taken, increased damage dealt",
        drawPath: JSON.parse(
        ...
        drawPath: JSON.parse(
            ...
            if (enemy.hitMarkers) {
                ...
                return 1 + 0.10*enemy.hitMarkers;
            } else {
                enemy.hitMarkers = 1;
                return 1;
            }
