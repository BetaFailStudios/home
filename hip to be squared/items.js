...
/*CrowB*/},{
        ...
        drawPath: pathParse(
            ...
            if (!enemy) return 1;
            if (enemy.health/enemy.healthMax > 0.75) return 2**rarity;
            else return 1;
        }
/*Guill*/},{
        name: "Guillotine",
...
/*Giant*/},{
        ...
        drawPath: pathParse(
            ...
            stats.health += 2+3*(rarity,rarityRaw%1)/15;
            stats.healthMax += 2+3*(rarity,rarityRaw%1)/15;
        }
/*4Leaf*/},{
        name: "4 Leaf Clover",
...
/*Metal*/},{
        ...
        drawPath: pathParse(
            ...
            if (random() < 0.2) {
                bullet.damage *= 2.5**rarity;
                bullet.targetSize *= 2**rarity;
